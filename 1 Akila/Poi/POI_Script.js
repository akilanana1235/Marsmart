...
function displayProductData() {
  ...
  let productInfo = `
  <button class="ui-btn ui-btn-inline" onclick="handleAddToFav()" id="addToFav-btn">
    <i class="fa fa-heart" aria-hidden="true" ></i>Add to Wishlist
  </button>
  <i class="fa fa-heart" aria-hidden="true" id="fav-icon" style="display:none; color:red;"></i>
...
//populating cards with necessary product details
