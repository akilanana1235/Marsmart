...
function displayProductData() {
  ...
  let productInfo = `
  <a href="#addToBasketPopUp" data-rel="popup" data-position-to="window" data-transition="pop" 
  class="ui-btn ui-corner-all ui-btn-inline ui-shadow"><i class="fa fa-heart" aria-hidden="true"></i>Add to Wishlist</a>
    ...
    if (product.id == id) {
      outputProductCard += `
            ...
            <div>
              ...
              <h6>
                <span style="padding-left:2.5em;">${product.category}</span>
